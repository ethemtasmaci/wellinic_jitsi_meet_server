...
var config = {
    ...
    hosts: {
        // XMPP domain.
        domain: 'wellinic.jitsi.meet.durumbildir.com.tr',

        // When using authentication, domain for guest users.
        // anonymousdomain: 'guest.example.com',

        // Domain for authenticated users. Defaults to <domain>.
        // authdomain: 'wellinic.jitsi.meet.durumbildir.com.tr',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.wellinic.jitsi.meet.durumbildir.com.tr',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'wellinic.jitsi.meet.durumbildir.com.tr',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://wellinic.jitsi.meet.durumbildir.com.tr/' + subdir + 'http-bind',

    // Websocket URL (XMPP)
    // websocket: 'wss://wellinic.jitsi.meet.durumbildir.com.tr/' + subdir + 'xmpp-websocket',
    ...
    // focusUserJid: 'focus@auth.wellinic.jitsi.meet.durumbildir.com.tr',

    // Option to send conference requests to jicofo over http (requires nginx rule for it)
    // conferenceRequestUrl:
    //   'https://<!--# echo var="http_host" default="wellinic.jitsi.meet.durumbildir.com.tr" -->/' + subdir + 'conference-request/v1',
    ...
    //     // by default uses:
    //     // 'https://wellinic.jitsi.meet.durumbildir.com.tr/static/oauth.html'
    //     redirectURI:
    //          'https://wellinic.jitsi.meet.durumbildir.com.tr/subfolder/static/oauth.html',
    // },
    ...
    p2p: {
        ...
        stunServers: [
            ...
            // { urls: 'stun:wellinic.jitsi.meet.durumbildir.com.tr:3478' },
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.wellinic.jitsi.meet.durumbildir.com.tr',
